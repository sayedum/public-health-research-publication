...
\small
\begin{tabular}{cc}	
\specialcell{\includegraphics[scale=0.45]{sorted_standard_grain_ratio_negative.png}  }  &  \specialcell{ \includegraphics[scale=0.45]{grain_later.png} } \\
Grains & Grains \\
\end{tabular}
\centering
...
\vspace{0.25cm}
\begin{tabular}{cc}	
\specialcell{\includegraphics[scale=0.55]{pair_plot_fruits_ratio} } & \specialcell{ \includegraphics[scale=0.5]{standard_fruit_ratio_mortality.png} } \\
Fruits & Fruits \\
\end{tabular}
...
\small
\begin{tabular}{c cc}	
	\includegraphics[scale=0.40]{standard_vegetable_ratio.png} & 
	\includegraphics[scale=0.40]{standard_actual_vegetable_intake_esrd_mortality.png} & 
	 \includegraphics[scale=0.40]{pairplot_vegetable_.png} 	  \\
...
\small
\begin{tabular}{ccc}
	\specialcell{\includegraphics[scale=0.35]{standard_actual_starchy_vegetable_esrd_mortality.png} } & 
	\specialcell{\includegraphics[scale=0.35]{standard_actual_red_and_orange_vegetable_esrd_mortality.png} } & 
	 \specialcell{\includegraphics[scale=0.35]{standard_actual_other_vegetable_esrd_mortality.png}	 } \\
...
\begin{tabular}{ccc}
	\specialcell{ \includegraphics[scale=0.35]{negatively_subgroup_avg_alcohol_intake} } & 
	\specialcell{\includegraphics[scale=0.35]{negatively_added_sugar_subgroup_line_2}   } &
	\specialcell{ \includegraphics[scale=0.35]{negatively_avg_nuts_subgroup_line_3}   } \\
	\specialcell{ \includegraphics[scale=0.35]{pairplot_avg_alc.png} } & 
	\specialcell{\includegraphics[scale=0.35]{pairplot_raw_data_added_sugar_esrd}  } &
	\specialcell{\includegraphics[scale=0.35]{pairplot_nuts_avg_negative.png}  } \\
	Alcohol & Sugar & Nuts \\
\end{tabular}
\centering
...
\hline
\specialcell{ \textbf{Data} \\ \textbf{Normal} \\\textbf{ized}}	& \textbf{Target}	&  \textbf{Approach}	&  \specialcell {\textbf{MSE} \\ \textbf{Train} }	&  \specialcell { \textbf{MSE} \\ \textbf{Test}}	&  \specialcell {\textbf{RMSE} \\ \textbf{Train}}	&  \specialcell { \textbf{RMSE} \\ \textbf{Test}}	&  \specialcell {\textbf{R2} \\ \textbf{Score} \\ \textbf{Train}}	 &  \specialcell {\textbf{Accuracy:} \\ \textbf{Test R2} \\ \textbf{Score} \\ \textbf{if not} \\ \textbf{mentioned}} \\
\hline
